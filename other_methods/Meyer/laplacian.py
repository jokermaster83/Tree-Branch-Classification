...
# 将 pc_skeletor 所在目录加入 Python 模块搜索路径
...
class LBC(LaplacianBasedContractionBase):
    ...
    def __least_squares_sparse(self, pcd_points, L, laplacian_weighting, positional_weighting):
        ...
        if self.debug:
            ...
            WL_L = WL @ L  # Define WL_L as the product of WL and L
...
if __name__ == "__main__":
    file_path = r"D:\Tree-Skeleton-Extraction\datas\txt\tree2.txt"     # Input incomplete tree point cloud
